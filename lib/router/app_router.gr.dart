...
import 'package:revup_provider/common_service/view/common_service_page.dart'
    as _i24;
import 'package:revup_provider/home/home.dart' as _i12;
...
import 'package:revup_provider/map_route/view/map_route_page.dart' as _i22;
...
import 'package:revup_provider/new_request/models/pending_repair_request.dart'
    as _i28;
import 'package:revup_provider/new_request/view/new_request_page.dart' as _i16;
import 'package:revup_provider/otp/view/otp_page.u.dart' as _i14;
import 'package:revup_provider/permission_page/permission_page.u.dart' as _i21;
...
class AppRouter extends _i26.RootStackRouter {
  ...
  final Map<String, _i26.PageFactory> pagesMap = {
    ...
    LoginEnterPhoneRoute.name: (routeData) {
      ...
      return _i26.AdaptivePage<void>(
          routeData: routeData,
          child: _i15.LoginEnterPhonePage(args.completer, args.phoneNumber,
              args.photoURL, args.uid, args.email,
              key: args.key));
    },
    ...
    CommonServiceRoute.name: (routeData) {
      ...
      return _i26.AdaptivePage<void>(
          routeData: routeData,
          child: _i24.CommonServicePage(args.providerID, args.sortType,
              key: args.key));
    },
    CommonProductRoute.name: (routeData) {
      ...
      return _i26.AdaptivePage<void>(
          routeData: routeData,
          child: _i25.CommonProductPage(args.products, args.complete,
              key: args.key));
    },
    HomeRoute.name: (routeData) {
      final args = routeData.argsAs<HomeRouteArgs>();
      return _i26.AdaptivePage<void>(
          routeData: routeData, child: _i12.HomePage(args.user, key: args.key));
    },
    HomePrimaryRoute.name: (routeData) {
      final args = routeData.argsAs<HomePrimaryRouteArgs>();
      return _i26.AdaptivePage<void>(
          routeData: routeData,
          child: _i12.HomePrimaryPage(args.user, key: args.key));
    },
    HistoryProviderRoute.name: (routeData) {
      return _i26.AdaptivePage<void>(
          routeData: routeData, child: const _i12.HistoryProviderPage());
    },
    NotificationProviderRoute.name: (routeData) {
      return _i26.AdaptivePage<void>(
          routeData: routeData, child: const _i12.NotificationProviderPage());
    },
    AccountRoute.name: (routeData) {
      final args = routeData.argsAs<AccountRouteArgs>();
      return _i26.AdaptivePage<void>(
          routeData: routeData,
          child: _i12.AccountPage(args.user, key: args.key));
    }
  };

  @override
  List<_i26.RouteConfig> get routes => [
        _i26.RouteConfig(SplashRoute.name, path: '/'),
        _i26.RouteConfig(AnalyticsRoute.name, path: '/analytics-page'),
        _i26.RouteConfig(LoginRoute.name, path: '/login-page'),
        _i26.RouteConfig(P3RequestDetailRoute.name,
            path: '/p3-request-detail-page'),
        _i26.RouteConfig(InfoRequestRoute.name, path: '/info-request-page'),
        _i26.RouteConfig(P14RepairCompleteRoute.name,
            path: '/p14-repair-complete-page'),
        _i26.RouteConfig(P13SelectOptionCompleteRoute.name,
            path: '/p13-select-option-complete-page'),
        _i26.RouteConfig(P16FinishedOrderDetailRoute.name,
            path: '/p16-finished-order-detail-page'),
        _i26.RouteConfig(AddServiceRoute.name, path: '/add-service-page'),
        _i26.RouteConfig(MyReviewRoute.name, path: '/my-review-page'),
        _i26.RouteConfig(VendorAuthenticationRoute.name,
            path: '/vendor-authentication-page'),
        _i26.RouteConfig(ListServiceRoute.name, path: '/list-service-page'),
        _i26.RouteConfig(DetailServiceRoute.name, path: '/detail-service-page'),
        _i26.RouteConfig(HistoryProviderDetailRoute.name,
            path: '/history-provider-detail-page'),
        _i26.RouteConfig(SignupRoute.name, path: '/signup-page'),
        _i26.RouteConfig(OTPRoute.name, path: '/o-tp-page'),
        _i26.RouteConfig(LoginEnterPhoneRoute.name,
            path: '/login-enter-phone-page'),
        _i26.RouteConfig(NewRequestRoute.name, path: '/new-request-page'),
        _i26.RouteConfig(P12DetailRoute.name, path: '/p12-detail-page'),
        _i26.RouteConfig(P10QuotePriceRoute.name,
            path: '/p10-quote-price-page'),
        _i26.RouteConfig(UpdateServiceRoute.name, path: '/update-service-page'),
        _i26.RouteConfig(AddProductRoute.name, path: '/add-product-page'),
        _i26.RouteConfig(PermissionRoute.name, path: '/permission-page'),
        _i26.RouteConfig(MapRouteRoute.name, path: '/map-route-page'),
        _i26.RouteConfig(ChangeLanguageRoute.name,
            path: '/change-language-page'),
        _i26.RouteConfig(CommonServiceRoute.name, path: '/common-service-page'),
        _i26.RouteConfig(CommonProductRoute.name, path: '/common-product-page'),
        _i26.RouteConfig(HomeRoute.name, path: '/home-page', children: [
          _i26.RouteConfig(HomePrimaryRoute.name,
              path: 'home-primary-page', parent: HomeRoute.name),
          _i26.RouteConfig(HistoryProviderRoute.name,
              path: 'history-provider-page', parent: HomeRoute.name),
          _i26.RouteConfig(NotificationProviderRoute.name,
...
/// generated route for
/// [_i2.AnalyticsPage]
class AnalyticsRoute extends _i26.PageRouteInfo<AnalyticsRouteArgs> {
  AnalyticsRoute({required String providerID, _i27.Key? key})
...
class P3RequestDetailRoute
    extends _i26.PageRouteInfo<P3RequestDetailRouteArgs> {
  P3RequestDetailRoute(
      {_i27.Key? key,
      required _i28.PendingRepairRequest record,
      required _i29.IList<_i7.PendingServiceModel> pendingService,
...
class P3RequestDetailRouteArgs {
  ...
  final _i28.PendingRepairRequest record;

  final _i29.IList<_i7.PendingServiceModel> pendingService;
...
/// generated route for
/// [_i5.InfoRequestPage]
class InfoRequestRoute extends _i26.PageRouteInfo<InfoRequestRouteArgs> {
  InfoRequestRoute(
      {_i27.Key? key,
      required _i30.AppUser consumer,
...
class P14RepairCompleteRoute
    extends _i26.PageRouteInfo<P14RepairCompleteRouteArgs> {
...
class P13SelectOptionCompleteRoute
    extends _i26.PageRouteInfo<P13SelectOptionCompleteRouteArgs> {
...
class P16FinishedOrderDetailRoute
    extends _i26.PageRouteInfo<P16FinishedOrderDetailRouteArgs> {
  P16FinishedOrderDetailRoute(
      {_i27.Key? key,
      required _i29.Tuple2<List<_i7.PendingServiceModel>,
...
class P16FinishedOrderDetailRouteArgs {
  ...
  final _i29.Tuple2<List<_i7.PendingServiceModel>, List<_i7.PaidServicesModel>>
      data;
...
/// generated route for
/// [_i9.AddServicePage]
class AddServiceRoute extends _i26.PageRouteInfo<AddServiceRouteArgs> {
  AddServiceRoute({required String providerID, _i27.Key? key})
...
/// generated route for
/// [_i10.MyReviewPage]
class MyReviewRoute extends _i26.PageRouteInfo<MyReviewRouteArgs> {
  MyReviewRoute({required String providerID, _i27.Key? key})
...
class VendorAuthenticationRoute
    extends _i26.PageRouteInfo<VendorAuthenticationRouteArgs> {
  VendorAuthenticationRoute({required _i30.AppUser user, _i27.Key? key})
...
/// generated route for
/// [_i9.ListServicePage]
class ListServiceRoute extends _i26.PageRouteInfo<ListServiceRouteArgs> {
  ListServiceRoute({required String providerID, _i27.Key? key})
...
class DetailServiceRoute extends _i26.PageRouteInfo<DetailServiceRouteArgs> {
  DetailServiceRoute(
...
class HistoryProviderDetailRoute extends _i26.PageRouteInfo<void> {
...
class OTPRoute extends _i26.PageRouteInfo<OTPRouteArgs> {
  OTPRoute(
      {required String phoneNumber,
      required _i31.Completer<String> completer,
      _i27.Key? key})
      : super(OTPRoute.name,
            path: '/o-tp-page',
            args: OTPRouteArgs(
...
class OTPRouteArgs {
  ...
  final _i31.Completer<String> completer;
...
/// generated route for
/// [_i15.LoginEnterPhonePage]
class LoginEnterPhoneRoute
    extends _i26.PageRouteInfo<LoginEnterPhoneRouteArgs> {
...
/// generated route for
/// [_i16.NewRequestPage]
class NewRequestRoute extends _i26.PageRouteInfo<NewRequestRouteArgs> {
  NewRequestRoute({_i27.Key? key, required String recordId})
...
/// generated route for
/// [_i17.P12DetailPage]
class P12DetailRoute extends _i26.PageRouteInfo<P12DetailRouteArgs> {
  P12DetailRoute({_i27.Key? key, required String recordId})
...
/// generated route for
/// [_i18.P10QuotePricePage]
class P10QuotePriceRoute extends _i26.PageRouteInfo<P10QuotePriceRouteArgs> {
  P10QuotePriceRoute(
      {_i27.Key? key,
      required _i28.PendingRepairRequest record,
      required _i29.IList<_i7.PendingServiceModel> pendingService,
...
/// generated route for
/// [_i19.UpdateServicePage]
class UpdateServiceRoute extends _i26.PageRouteInfo<UpdateServiceRouteArgs> {
  UpdateServiceRoute(
      {required String providerID,
      required String category,
...
/// generated route for
/// [_i21.PermissionPage]
class PermissionRoute extends _i26.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.MapRoutePage]
class MapRouteRoute extends _i26.PageRouteInfo<MapRouteRouteArgs> {
  MapRouteRoute(
      {_i27.Key? key, required String recordId, required String consumerId})
...
/// generated route for
/// [_i23.ChangeLanguagePage]
class ChangeLanguageRoute extends _i26.PageRouteInfo<void> {
...
/// generated route for
/// [_i24.CommonServicePage]
class CommonServiceRoute extends _i26.PageRouteInfo<CommonServiceRouteArgs> {
  CommonServiceRoute(
      {required String providerID, required int sortType, _i27.Key? key})
...
/// generated route for
/// [_i12.HomePrimaryPage]
class HomePrimaryRoute extends _i26.PageRouteInfo<HomePrimaryRouteArgs> {
  HomePrimaryRoute({required _i30.AppUser user, _i27.Key? key})
...
/// generated route for
/// [_i12.HistoryProviderPage]
class HistoryProviderRoute extends _i26.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.NotificationProviderPage]
class NotificationProviderRoute extends _i26.PageRouteInfo<void> {
...
class AccountRoute extends _i26.PageRouteInfo<AccountRouteArgs> {
  AccountRoute({required _i30.AppUser user, _i27.Key? key})
