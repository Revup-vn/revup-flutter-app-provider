...
class SelectServiceRequestItem extends StatelessWidget {
          ...
          builder: (context, state) {
            return state.when(
              ...
              success: (selectOptionCompleteModel) => ListView.builder(
                ...
                itemCount: selectOptionCompleteModel.requestServiceModel.length,
                itemBuilder: (BuildContext context, int index) {
                  return SizedBox(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        AutoSizeText(
                          selectOptionCompleteModel.requestServiceModel
                              .elementAt(index)
                              .name,
