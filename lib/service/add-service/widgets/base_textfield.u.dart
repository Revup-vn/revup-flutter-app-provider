  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedErrorBorder:
            _buildInputBorder(color: Theme.of(context).errorColor, width: 1),
        enabledBorder: _buildInputBorder(
          color: borderType != BorderType.UNDERLINE
              ? Colors.grey
              : Theme.of(context).dividerColor,
        ),
        disabledBorder:
            _buildInputBorder(color: Theme.of(context).disabledColor),
